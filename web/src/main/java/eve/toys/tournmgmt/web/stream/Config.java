...
public class Config {
    ...
    public static Config configure(HistoricalClient historical) {
        ...
        Widget redTeamHistory = new Widget(WidgetType.TEAM_HISTORY, "Red Team History", new TeamHistory("red"));
        Widget blueTeamHistory = new Widget(WidgetType.TEAM_HISTORY, "Blue Team History", new TeamHistory("blue"));
