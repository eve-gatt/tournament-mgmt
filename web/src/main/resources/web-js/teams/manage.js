(function () {
    ...
    function renderTeams(data) {
        if (data.length > 0) {
            ...
            entering.classed('red', d => d.member_count === 0);
            entering.classed('yellow', d => (d.member_count > 0 && !d.locked) || (d.locked && d.message));
            entering.classed('green', d => d.locked && !d.message);
